 ...
 * - {@link ItemModes#CHISEL_DRAWN_REGION}
 * - {@link ItemModes#CHISEL_SNAP8}
 * - {@link ItemModes#CHISEL_SNAP4}
 * - {@link ItemModes#CHISEL_SNAP2}
 * - {@link ItemModes#CHISEL_LINE}
 * - {@link ItemModes#CHISEL_PLANE}
 * - {@link ItemModes#CHISEL_CUBE3}
 * - {@link ItemModes#CHISEL_CUBE5}
 * - {@link ItemModes#CHISEL_CUBE7}
 * - {@link ItemModes#CHISEL_SINGLE}
 */
public class ChiselTypeIterator extends BaseChiselIterator implements ChiselIterator {
    ...
    /**
     * Iterator specifically for {@link ItemModes#CHISEL_DRAWN_REGION}
     */
     ...
     * - {@link ItemModes#CHISEL_SINGLE}
     */
    public ChiselTypeIterator(final ItemModes mode, final BlockPos partial, final Direction side) {
        super(side);
        int offset = 0;
